...
//
//public class MainActivity_bk_for_ViewPagerAdapter extends AppCompatActivity implements TabLayout.OnTabSelectedListener{
...
//        }
//        //create pager
////        Toast.makeText(this, String.valueOf(tmp_index), Toast.LENGTH_SHORT).show();
////        adapter = new Pager(getSupportFragmentManager(),tmp_index);
//          mViewPagerAdapter = new ViewPagerAdapter(getApplicationContext(),getResources(),currArrayListQuesstionGroupClass.get(currQuesstionGroupClass).getQuestionClassArrayList());
...
////        Toast.makeText(this, "i'm in onTabSelected", Toast.LENGTH_SHORT).show();
////        Toast.makeText(this, "tab.getPosition() = "+ String.valueOf(tab.getPosition()), Toast.LENGTH_SHORT).show();
